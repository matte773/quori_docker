...
class ConfigActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ConfigGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += ConfigGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ConfigActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = ConfigGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new ConfigGoal()
    }
...
module.exports = ConfigActionGoal;
