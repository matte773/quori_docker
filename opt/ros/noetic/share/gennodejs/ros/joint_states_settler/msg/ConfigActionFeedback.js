...
class ConfigActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new ConfigFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ConfigFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ConfigActionFeedback(null);
    ...
    data.feedback = ConfigFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ConfigActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = ConfigFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new ConfigFeedback()
    }
...
module.exports = ConfigActionFeedback;
