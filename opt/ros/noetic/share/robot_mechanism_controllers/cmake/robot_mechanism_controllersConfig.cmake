...
if("FALSE" STREQUAL "TRUE")
  set(robot_mechanism_controllers_SOURCE_PREFIX /tmp/binarydeb/ros-noetic-robot-mechanism-controllers-1.10.18)
  set(robot_mechanism_controllers_DEVEL_PREFIX /tmp/binarydeb/ros-noetic-robot-mechanism-controllers-1.10.18/obj-x86_64-linux-gnu/devel)
  ...
  set(robot_mechanism_controllers_INSTALL_PREFIX /opt/ros/noetic)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robot_mechanism_controllers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT robot_mechanism_controllers_NUM_DUMMY_TARGETS)
      set(robot_mechanism_controllers_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::robot_mechanism_controllers::wrapped-linker-option${robot_mechanism_controllers_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR robot_mechanism_controllers_NUM_DUMMY_TARGETS "${robot_mechanism_controllers_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::robot_mechanism_controllers::wrapped-linker-option${robot_mechanism_controllers_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND robot_mechanism_controllers_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(robot_mechanism_controllers_EXPORTED_TARGETS ${${robot_mechanism_controllers_dep}_EXPORTED_TARGETS})
endforeach()
