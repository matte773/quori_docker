...
bool operator==(const ::pr2_controllers_msgs::SingleJointPositionGoal_<ContainerAllocator1> & lhs, const ::pr2_controllers_msgs::SingleJointPositionGoal_<ContainerAllocator2> & rhs)
{
