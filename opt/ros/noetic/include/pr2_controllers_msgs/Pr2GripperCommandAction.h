...
bool operator==(const ::pr2_controllers_msgs::Pr2GripperCommandAction_<ContainerAllocator1> & lhs, const ::pr2_controllers_msgs::Pr2GripperCommandAction_<ContainerAllocator2> & rhs)
{
