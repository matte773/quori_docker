...
bool operator==(const ::pr2_controllers_msgs::JointTrajectoryAction_<ContainerAllocator1> & lhs, const ::pr2_controllers_msgs::JointTrajectoryAction_<ContainerAllocator2> & rhs)
{
