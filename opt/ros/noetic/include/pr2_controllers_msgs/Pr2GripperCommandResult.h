...
bool operator==(const ::pr2_controllers_msgs::Pr2GripperCommandResult_<ContainerAllocator1> & lhs, const ::pr2_controllers_msgs::Pr2GripperCommandResult_<ContainerAllocator2> & rhs)
{
