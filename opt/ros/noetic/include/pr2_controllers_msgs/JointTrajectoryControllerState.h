...
bool operator==(const ::pr2_controllers_msgs::JointTrajectoryControllerState_<ContainerAllocator1> & lhs, const ::pr2_controllers_msgs::JointTrajectoryControllerState_<ContainerAllocator2> & rhs)
{
