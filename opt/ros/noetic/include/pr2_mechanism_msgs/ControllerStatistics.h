...
bool operator==(const ::pr2_mechanism_msgs::ControllerStatistics_<ContainerAllocator1> & lhs, const ::pr2_mechanism_msgs::ControllerStatistics_<ContainerAllocator2> & rhs)
{
