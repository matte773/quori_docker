...
bool operator==(const ::pr2_mechanism_msgs::LoadControllerResponse_<ContainerAllocator1> & lhs, const ::pr2_mechanism_msgs::LoadControllerResponse_<ContainerAllocator2> & rhs)
{
