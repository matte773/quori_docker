...
struct MechanismStatistics_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::pr2_mechanism_msgs::ActuatorStatistics_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::pr2_mechanism_msgs::ActuatorStatistics_<ContainerAllocator> >> _actuator_statistics_type;
  _actuator_statistics_type actuator_statistics;

   typedef std::vector< ::pr2_mechanism_msgs::JointStatistics_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::pr2_mechanism_msgs::JointStatistics_<ContainerAllocator> >> _joint_statistics_type;
  _joint_statistics_type joint_statistics;

   typedef std::vector< ::pr2_mechanism_msgs::ControllerStatistics_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::pr2_mechanism_msgs::ControllerStatistics_<ContainerAllocator> >> _controller_statistics_type;
...
bool operator==(const ::pr2_mechanism_msgs::MechanismStatistics_<ContainerAllocator1> & lhs, const ::pr2_mechanism_msgs::MechanismStatistics_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.actuator_statistics == rhs.actuator_statistics &&
    lhs.joint_statistics == rhs.joint_statistics &&
    lhs.controller_statistics == rhs.controller_statistics;
}
