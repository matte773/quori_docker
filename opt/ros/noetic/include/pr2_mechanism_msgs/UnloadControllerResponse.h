...
bool operator==(const ::pr2_mechanism_msgs::UnloadControllerResponse_<ContainerAllocator1> & lhs, const ::pr2_mechanism_msgs::UnloadControllerResponse_<ContainerAllocator2> & rhs)
{
