...
struct ListControllersResponse_
{
  ...
  _controllers_type controllers;
   ...
   typedef std::vector<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>> _state_type;
  _state_type state;
...
bool operator==(const ::pr2_mechanism_msgs::ListControllersResponse_<ContainerAllocator1> & lhs, const ::pr2_mechanism_msgs::ListControllersResponse_<ContainerAllocator2> & rhs)
{
...
struct Printer< ::pr2_mechanism_msgs::ListControllersResponse_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::pr2_mechanism_msgs::ListControllersResponse_<ContainerAllocator>& v)
  {
    ...
    {
      s << indent << "  state[" << i << "]: ";
      Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.state[i]);
    }
  }
};
