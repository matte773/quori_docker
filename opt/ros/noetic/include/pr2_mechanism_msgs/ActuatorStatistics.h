...
bool operator==(const ::pr2_mechanism_msgs::ActuatorStatistics_<ContainerAllocator1> & lhs, const ::pr2_mechanism_msgs::ActuatorStatistics_<ContainerAllocator2> & rhs)
{
  return lhs.name == rhs.name &&
    lhs.device_id == rhs.device_id &&
    lhs.timestamp == rhs.timestamp &&
    lhs.encoder_count == rhs.encoder_count &&
    lhs.encoder_offset == rhs.encoder_offset &&
    lhs.position == rhs.position &&
    lhs.encoder_velocity == rhs.encoder_velocity &&
    lhs.velocity == rhs.velocity &&
    lhs.calibration_reading == rhs.calibration_reading &&
    lhs.calibration_rising_edge_valid == rhs.calibration_rising_edge_valid &&
    lhs.calibration_falling_edge_valid == rhs.calibration_falling_edge_valid &&
    lhs.last_calibration_rising_edge == rhs.last_calibration_rising_edge &&
    lhs.last_calibration_falling_edge == rhs.last_calibration_falling_edge &&
    lhs.is_enabled == rhs.is_enabled &&
    lhs.halted == rhs.halted &&
    lhs.last_commanded_current == rhs.last_commanded_current &&
    lhs.last_commanded_effort == rhs.last_commanded_effort &&
    lhs.last_executed_current == rhs.last_executed_current &&
    lhs.last_executed_effort == rhs.last_executed_effort &&
    lhs.last_measured_current == rhs.last_measured_current &&
    lhs.last_measured_effort == rhs.last_measured_effort &&
    lhs.motor_voltage == rhs.motor_voltage &&
    lhs.num_encoder_errors == rhs.num_encoder_errors;
}
