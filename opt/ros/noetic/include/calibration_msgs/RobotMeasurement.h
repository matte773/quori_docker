...
struct RobotMeasurement_
{
  ...
  (void)_alloc;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _sample_id_type;
  ...
  _chain_id_type chain_id;
   ...
   typedef std::vector< ::calibration_msgs::CameraMeasurement_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::calibration_msgs::CameraMeasurement_<ContainerAllocator> >> _M_cam_type;
  _M_cam_type M_cam;

   typedef std::vector< ::calibration_msgs::LaserMeasurement_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::calibration_msgs::LaserMeasurement_<ContainerAllocator> >> _M_laser_type;
  _M_laser_type M_laser;

   typedef std::vector< ::calibration_msgs::ChainMeasurement_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::calibration_msgs::ChainMeasurement_<ContainerAllocator> >> _M_chain_type;
...
bool operator==(const ::calibration_msgs::RobotMeasurement_<ContainerAllocator1> & lhs, const ::calibration_msgs::RobotMeasurement_<ContainerAllocator2> & rhs)
{
  return lhs.sample_id == rhs.sample_id &&
    lhs.target_id == rhs.target_id &&
    lhs.chain_id == rhs.chain_id &&
    lhs.M_cam == rhs.M_cam &&
    lhs.M_laser == rhs.M_laser &&
    lhs.M_chain == rhs.M_chain;
}
...
struct Printer< ::calibration_msgs::RobotMeasurement_<ContainerAllocator> >
{
  ...
  {
    s << indent << "sample_id: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.sample_id);
    s << indent << "target_id: ";
