...
struct DenseLaserObjectFeatures_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::calibration_msgs::DenseLaserPoint_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::calibration_msgs::DenseLaserPoint_<ContainerAllocator> >> _dense_laser_points_type;
...
bool operator==(const ::calibration_msgs::DenseLaserObjectFeatures_<ContainerAllocator1> & lhs, const ::calibration_msgs::DenseLaserObjectFeatures_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.dense_laser_points == rhs.dense_laser_points &&
