...
struct LaserMeasurement_
{
  ...
  _header_type header;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _laser_id_type;
  _laser_id_type laser_id;

   typedef std::vector< ::sensor_msgs::JointState_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::sensor_msgs::JointState_<ContainerAllocator> >> _joint_points_type;
...
bool operator==(const ::calibration_msgs::LaserMeasurement_<ContainerAllocator1> & lhs, const ::calibration_msgs::LaserMeasurement_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.laser_id == rhs.laser_id &&
    lhs.joint_points == rhs.joint_points &&
    lhs.verbose == rhs.verbose &&
    lhs.snapshot == rhs.snapshot &&
    lhs.laser_image == rhs.laser_image &&
    lhs.image_features == rhs.image_features &&
    lhs.joint_features == rhs.joint_features;
}
...
struct Printer< ::calibration_msgs::LaserMeasurement_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::calibration_msgs::LaserMeasurement_<ContainerAllocator>& v)
  {
    ...
    s << indent << "laser_id: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.laser_id);
