...
struct JTCartesianControllerState_
{
  ...
  _F_type F;
   ...
   typedef std::vector<double, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<double>> _tau_pose_type;
  _tau_pose_type tau_pose;

   typedef std::vector<double, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<double>> _tau_posture_type;
...
bool operator==(const ::robot_mechanism_controllers::JTCartesianControllerState_<ContainerAllocator1> & lhs, const ::robot_mechanism_controllers::JTCartesianControllerState_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.x == rhs.x &&
    lhs.x_desi == rhs.x_desi &&
    lhs.x_desi_filtered == rhs.x_desi_filtered &&
    lhs.x_err == rhs.x_err &&
    lhs.xd == rhs.xd &&
    lhs.xd_desi == rhs.xd_desi &&
    lhs.F == rhs.F &&
    lhs.tau_pose == rhs.tau_pose &&
    lhs.tau_posture == rhs.tau_posture &&
    lhs.tau == rhs.tau &&
    lhs.J == rhs.J &&
    lhs.N == rhs.N;
}
