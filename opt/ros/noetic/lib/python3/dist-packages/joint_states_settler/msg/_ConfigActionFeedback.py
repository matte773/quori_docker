...
"""autogenerated by genpy from joint_states_settler/ConfigActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class ConfigActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "joint_states_settler/ConfigActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','joint_states_settler/ConfigFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ConfigActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = joint_states_settler.msg.ConfigFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = joint_states_settler.msg.ConfigFeedback()
