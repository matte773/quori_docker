...
"""autogenerated by genpy from joint_states_settler/ConfigActionResult.msg. Do not edit."""
import codecs
import sys
...
class ConfigActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "joint_states_settler/ConfigActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','joint_states_settler/ConfigResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ConfigActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = joint_states_settler.msg.ConfigResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = joint_states_settler.msg.ConfigResult()
